...
# mac
$ wget https://github.com/gjbae1212/gossm/releases/download/v1.0.2/gossm_1.0.2_Darwin_x86_64.tar.gz

# linux
$ wget https://github.com/gjbae1212/gossm/releases/download/v1.0.2/gossm_1.0.2_Linux_x86_64.tar.gz

# window
$ wget https://github.com/gjbae1212/gossm/releases/download/v1.0.2/gossm_1.0.2_Windows_x86_64.tar.gz
```
